...
import (
	answercmd "github.com/sungorilla2036/crowdsourced/cmd"
...
type pluginInfo struct {
	// Name of the plugin e.g. github.com/sungorilla2036/crowdsourced-plugins/github-connector
	Name string
...
func formatPlugins(plugins []string) (formatted []*pluginInfo) {
	for _, plugin := range plugins {
		...
		// plugin description like this 'github.com/sungorilla2036/crowdsourced-plugins/github-connector@latest=/local/path'
		info := &pluginInfo{}
...
func downloadGoModFile(b *buildingMaterial) (err error) {
	...
	if len(b.answerModuleReplacement) > 0 {
		replacement := fmt.Sprintf("%s=%s", "github.com/sungorilla2036/crowdsourced", b.answerModuleReplacement)
		err = b.newExecCmd("go", "mod", "edit", "-replace", replacement).Run()
		if err != nil {
			return err
		}
...
func copyUIFiles(b *buildingMaterial) (err error) {
	goListCmd := b.newExecCmd("go", "list", "-mod=mod", "-m", "-f", "{{.Dir}}", "github.com/sungorilla2036/crowdsourced")
	...
	localUIBuildDir := filepath.Join(b.tmpDir, "vendor/github.com/sungorilla2036/crowdsourced/ui/")
	...
	pluginsDir := filepath.Join(b.tmpDir, "vendor/github.com/sungorilla2036/crowdsourced-plugins/")
...
func overwriteIndexTs(b *buildingMaterial) (err error) {
	localUIPluginDir := filepath.Join(b.tmpDir, "vendor/github.com/sungorilla2036/crowdsourced/ui/src/plugins/")
...
func replaceNecessaryFile(b *buildingMaterial) (err error) {
	...
	uiBuildDir := filepath.Join(b.tmpDir, "vendor/github.com/sungorilla2036/crowdsourced/ui")
...
func mergeI18nFiles(b *buildingMaterial) (err error) {
	...
	originalI18nDir := filepath.Join(b.tmpDir, "vendor/github.com/sungorilla2036/crowdsourced/i18n")
...
func buildBinary(b *buildingMaterial) (err error) {
	...
	cmdPkg := "github.com/sungorilla2036/crowdsourced/cmd"
