...
GO_FLAGS=-ldflags="-X github.com/sungorilla2036/crowdsourced/cmd.Version=$(VERSION) -X 'github.com/sungorilla2036/crowdsourced/cmd.Revision=$(Revision)' -X 'github.com/sungorilla2036/crowdsourced/cmd.Time=`date +%s`' -extldflags -static"
